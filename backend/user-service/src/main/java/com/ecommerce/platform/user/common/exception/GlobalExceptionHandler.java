package com.ecommerce.platform.user.common.exception;


import com.ecommerce.platform.user.common.exception.custom.CustomException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleValidationException(BindException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(ApiResponseUtil.error(
                        Collections.singletonList( ex.getBindingResult().toString()),
                        ex.getMessage(),
